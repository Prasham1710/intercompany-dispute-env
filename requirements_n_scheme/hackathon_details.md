I am participating in the openENV Hackathon, here are the details about the
hackathon:

## The Task:
Build a complete, real-world OpenENV environment that an AI agent can
learn from through the standard step() / reset() / state() API.
...
## Evaluation Criteria - How judging works
...
Here is the link of the OpenENV documentation QuickStart:
https://meta-pytorch.org/OpenEnv/auto_getting_started/index.html

Use the official documentation of OpenENV as the reference to understand
